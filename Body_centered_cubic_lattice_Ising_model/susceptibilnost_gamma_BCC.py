...
data = pyalps.loadMeasurements(pyalps.getResultFiles(prefix='parmBCCb'),'Connected Susceptibility')
...
plt.title(ur'3D Izingov model na zapreminski centriranoj kubnoj rešetki, $\gamma/\nu =$ %.10s' % params[1])
plt.savefig("figure_gamma_over_nu_BCC.eps",dpi=300)