...
parms = []
for l in [4,8,10,12,14,16]: 
    for t in np.linspace(0.0,7.0,71):
        parms.append(
            { 
...
plt.title(u'2D Izingov model na prostoj kubnoj rešetki')
plt.legend(loc='best')
plt.savefig("figure1_SC.eps",dpi=300)
...
plt.title(u'2D Izingov model na prostoj kubnoj rešetki')
plt.legend(loc='best')
plt.savefig("figure2_SC.eps",dpi=300)
...
plt.title(u'2D Izingov model  na prostoj kubnoj rešetki')
plt.legend(loc='best')
plt.savefig("figure3_SC.eps",dpi=300)
...
plt.title(u'2D Izingov model na prostoj kubnoj rešetki')
plt.legend(loc='best')
plt.savefig("figure4_SC.eps",dpi=300)
...
plt.title(u'2D Izingov model na prostoj kubnoj rešetki')
plt.legend(loc='best')
plt.savefig("figure5_SC.eps",dpi=300)
