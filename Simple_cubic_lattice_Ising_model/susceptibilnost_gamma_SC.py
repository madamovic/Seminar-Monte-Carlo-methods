...
data = pyalps.loadMeasurements(pyalps.getResultFiles(prefix='parmSC'),'Connected Susceptibility')
...
plt.title(ur'3D Izingov model na prostoj kubnoj rešetki, $\gamma/\nu =$ %.10s' % params[1])
plt.savefig("figure_gamma_over_nu_SC.eps",dpi=300)