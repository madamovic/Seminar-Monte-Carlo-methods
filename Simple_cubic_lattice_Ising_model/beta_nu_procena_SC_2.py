...
lista_beta=np.linspace(0.0,1.6,15001)

for beta_over_nu in np.linspace(0.0,1.6,15001):
	file=open('mag_rounded_t_redosled_3D_Ising_SC.txt')
	...
	y8 = y8 / pow(float(8),-beta_over_nu)
