...
data = pyalps.loadMeasurements(pyalps.getResultFiles(prefix='parm2'),'Connected Susceptibility')
...
plt.title(ur'2D Izingov model na Kagome rešetki, $\gamma/\nu =$ %.10s' % params[1])
plt.savefig("figure_gamma_over_nu_Kagome.eps",dpi=300)