...
plt.legend(loc='best')
plt.savefig("figure1_Kagome.eps",dpi=300)
...
plt.title(u'2D Izingov model na Kagome rešetki')
plt.legend(loc='best')
plt.savefig("figure2_Kagome.eps",dpi=300)
...
plt.title(u'2D Izingov model  na Kagome rešetki')
plt.legend(loc='best')
plt.savefig("figure3_Kagome.eps",dpi=300)
...
plt.title(u'2D Izingov model na Kagome rešetki')
plt.legend(loc='best')
plt.savefig("figure4_Kagome.eps",dpi=300)
...
plt.title(u'2D Izingov model na Kagome rešetki')
plt.legend(loc='best')
plt.savefig("figure5_Kagome.eps",dpi=300)
