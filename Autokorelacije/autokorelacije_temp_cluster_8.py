...
input_file = pyalps.writeInputFiles('clustemp8',parms)
pyalps.runApplication('spinmc',input_file,Tmin=5)

#load the binning analysis for the absolute value of the magnetization
binning = pyalps.loadBinningAnalysis(pyalps.getResultFiles(prefix='clustemp8'),'|Magnetization|')
...
plt.legend(loc="best")
plt.savefig("bining_cluster_temp_8.eps",dpi=300)
