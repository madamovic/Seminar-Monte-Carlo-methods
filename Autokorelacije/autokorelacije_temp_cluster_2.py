...
input_file = pyalps.writeInputFiles('clustemp2',parms)
pyalps.runApplication('spinmc',input_file,Tmin=5)

#load the binning analysis for the absolute value of the magnetization
binning = pyalps.loadBinningAnalysis(pyalps.getResultFiles(prefix='clustemp2'),'|Magnetization|')
...
plt.legend(loc="best")
plt.savefig("bining_cluster_temp_2.eps",dpi=300)
