...
input_file = pyalps.writeInputFiles('loctemp7',parms)
pyalps.runApplication('spinmc',input_file,Tmin=5)

#load the binning analysis for the absolute value of the magnetization
binning = pyalps.loadBinningAnalysis(pyalps.getResultFiles(prefix='loctemp7'),'|Magnetization|')
...
plt.legend(loc="best")
plt.savefig("bining_local_temp_7.eps",dpi=300)
