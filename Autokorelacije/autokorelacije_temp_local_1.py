...
input_file = pyalps.writeInputFiles('loctemp1',parms)
pyalps.runApplication('spinmc',input_file,Tmin=5)

#load the binning analysis for the absolute value of the magnetization
binning = pyalps.loadBinningAnalysis(pyalps.getResultFiles(prefix='loctemp1'),'|Magnetization|')
...
plt.legend(loc="best")
plt.savefig("bining_local_temp_1.eps",dpi=300)
