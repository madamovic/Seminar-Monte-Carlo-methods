...
input_file = pyalps.writeInputFiles('parmHladL',parms)
res = pyalps.runApplication('dirloop_sse',input_file,Tmin=5)

#load the magnetization and collect it as function of field h
data = pyalps.loadMeasurements(pyalps.getResultFiles(prefix='parmHladL'),'Magnetization Density')
...
plt.legend(loc='best')
plt.savefig("magnetization_heisenberg_ladder_L.eps",dpi=300)
