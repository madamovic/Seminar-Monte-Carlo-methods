...
input_file = pyalps.writeInputFiles('parmHmagT',parms)
res = pyalps.runApplication('dirloop_sse',input_file,Tmin=5)

#load the magnetization and collect it as function of field h
data = pyalps.loadMeasurements(pyalps.getResultFiles(prefix='parmHmagT'),'Magnetization Density')
...
plt.legend(loc='best')
plt.savefig("magnetization_heisenberg_chain_T.eps",dpi=300)
