...
lista_beta=np.linspace(0.0,1.5,15001)

for beta_over_nu in np.linspace(0.0,1.5,15001):
	file=open('mag_rounded_t_redosled_2D_Ising_triangular.txt')
	...
	y16 = y16 / pow(float(16),-beta_over_nu)
	y24 = y24 / pow(float(24),-beta_over_nu)  
