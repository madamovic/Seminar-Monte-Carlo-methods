...
if __name__ == '__main__':
    ...
    xintercept5, yintercept5 = intersection(x8, y8, x28, y28)
    listaintersceptsx=[]
    listaintersceptsy=[]
...
lodnosi=[16.0/8.0,24.0/8.0,32.0/8.0,40.0/8.0,28.0/8.0]
...
plt.savefig("presek_kumulanata_honeycomb_tc_lnL.eps",dpi=300)
plt.show()
