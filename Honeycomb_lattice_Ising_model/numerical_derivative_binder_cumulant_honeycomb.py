...
plt.figure()
plt.plot(x40,y40,label='$U_{4}$',color='b')
plt.plot(xizv40,yizv40,label='$dU_{4}/dT$',color='r')
plt.legend(loc='best')
plt.savefig("figure_derivative_honeycomb_1.eps",dpi=300)
...
plt.savefig("figure_derivative_honeycomb_2.eps",dpi=300)
