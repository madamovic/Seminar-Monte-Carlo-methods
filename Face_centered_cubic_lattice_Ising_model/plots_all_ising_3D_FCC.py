...
for l in [4,6,8,10,12]: 
    for t in np.linspace(0.0,12.0,121):
        parms.append(
            { 
              'LATTICE'        : "fcc",
...
plt.legend(loc='best')
plt.savefig("figure_FCC_1.eps",dpi=300)
...
plt.title(u'3D Izingov model na površinski centriranoj kubnoj rešetki')
plt.legend(loc='best')
plt.savefig("figure_FCC_2.eps",dpi=300)
...
plt.title(u'3D Izingov model na površinski centriranoj kubnoj rešetki')
plt.legend(loc='best')
plt.savefig("figure_FCC_3.eps",dpi=300)
...
plt.title(u'3D Izingov model na površinski centriranoj kubnoj rešetki')
plt.legend(loc='best')
plt.savefig("figure_FCC_4.eps",dpi=300)
...
plt.title(u'3D Izingov model na površinski centriranoj kubnoj rešetki')
plt.legend(loc='best')
plt.savefig("figure_FCC_5.eps",dpi=300)
