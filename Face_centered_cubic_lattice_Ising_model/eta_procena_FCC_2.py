...
lista_eta=np.linspace(1.9,2.1,3001)

for two_minus_eta in np.linspace(1.9,2.1,3001):
	file=open('susc_rounded_t_redosled_3D_Ising_BCC.txt')
	...
	y6 = y6 / pow(float(6),two_minus_eta)
