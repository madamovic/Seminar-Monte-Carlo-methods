...
file=open('stiffness_rounded_heisenberg_redosled_druga.txt')
...
if __name__ == '__main__':
    ...
    plt.savefig("presek_kumulanata_heisenbeg_stiffness_druga.eps",dpi=300)
    plt.show()

    for i in range(0,len(listaintersceptsx)):
		print(listaintersceptsx[i])

    textfile = open("kumulanti_stiffness_preseci_pojedinacni_druga.txt", "w")
